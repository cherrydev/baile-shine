...
class InputBase(object):
    ...
    def __init__(self, pin_name, pull=None, convert_func=None):
        '''Arguments are:
        pin_name:  The machineoard pin name, such as X1 or Y2, as string.  Optionally,
        ...
        pull:  can be used to enable a pull-up or pull-down on the input line.  Must be
            one of the machine.Pin.PULL_ constants and defaults to no pull on the input line.
        ...
        self._pin = machine.Pin(self._pin_name, machine.Pin.IN, pull)
...
class DigitalBase(InputBase):
    ...
    def __init__(self, pin_name, pull=machine.Pin.PULL_UP, stable_read_count=12, **kwargs):
